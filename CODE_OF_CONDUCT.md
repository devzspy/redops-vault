...
requests, discussions, code review) and also applies when an individual
...
[private security advisory](https://github.com/devzspy/redops-vault/security/advisories/new)
against this repository — it isn't only for security bugs, and it's the
one built-in way to start a private conversation with the maintainer
without publishing your report or contact details. All complaints will be
